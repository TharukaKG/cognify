...
class IOSVoiceToTextParser: VoiceToTextParser, ObservableObject {
    ...
    private let _state = IOSMutableStateflow(
        initialValue: VoiceToTextParserState(result: "", error: nil, isSpeaking: false)
    )
    ...
    func reset() {
        self.stopListening()
        _state.value = VoiceToTextParserState(result: "", error: nil, isSpeaking: false)
    }
    ...
    private func updateState(result: String? = nil, error: String? = nil, isSpeaking: Bool? = nil) {
